...
if(!options.loopHorizontal){document.querySelector(domStrings.arrowNext).style.opacity='0';document.querySelector(domStrings.arrowPrev).style.opacity='1';}}
function addVerticalNavigation(){var navigation=document.createElement('div');navigation.setAttribute('id',SECTION_NAV);var divUl=document.createElement('ul');navigation.appendChild(divUl);var menuEls=document.getElementById('menuElements');appendTo(navigation,menuEls);var nav=$(SECTION_NAV_SEL)[0];addClass(nav,'fp-'+options.navigationPosition);if(options.showActiveTooltip){addClass(nav,SHOW_ACTIVE_TOOLTIP);}
...
if(!options.loopHorizontal&&options.controlArrows){if(next(destiny)!=null&&v.slideIndex!==0){document.querySelector(domStrings.arrowNext).style.opacity='1';document.querySelector(domStrings.arrowNext).style.right=null;document.querySelector(domStrings.arrowPrev).style.opacity='1';document.querySelector(domStrings.arrowPrev).style.left=null;}else if(v.slideIndex==0){document.querySelector(domStrings.arrowNext).style.opacity='1';document.querySelector(domStrings.arrowNext).style.right=null;document.querySelector(domStrings.arrowPrev).style.opacity='0';document.querySelector(domStrings.arrowPrev).style.left='0';}else if(v.slideIndex!==0){document.querySelector(domStrings.arrowNext).style.opacity='0';document.querySelector(domStrings.arrowNext).style.right='0';document.querySelector(domStrings.arrowPrev).style.opacity='1';document.querySelector(domStrings.arrowPrev).style.left=null;}}
